...
def create_trend_analysis_pdf(fig, filename="trend_analysis.pdf"):
    # Diagramm als Bild speichern
    img_path = "temp-plot.png"
    ...
    img = Image(img_path)
    img._restrictSize(500, 300)  # Größenbeschränkung für das Bild
    elements.append(img)
    
    doc.build(elements)
    os.remove(img_path)  # Temporäres Bild löschen
...
def show_trend_analysis():
    ...
    # Hier die Erstellung des Plotly-Diagramms integrieren
    fig = go.Figure()
    # Beispielhafte Datenanzeige
